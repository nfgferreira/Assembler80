...
def test_all_8085_instructions():
    ...
    expected = [0xc3, 0x32, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 
                ...
                0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xc3, 0x36, 0x00, 0x01, 
                0x00, 0x02, 0x00, 0x01, 0xd2, 0x04, 0x02, 0x03, 0x04, 0x05, 0x06, 0xfe, 0x07, 0x09, 0x0a, 0x0b,
                0x0c, 0x0d, 0x0e, 0xfe, 0x0f, 0x11, 0x34, 0x12, 0x12, 0x13, 0x14, 0x15, 0x16, 0x12, 0x17, 0x19,
                ...
                0x70, 0x25, 0x32, 0x31, 0x00, 0x33, 0x34, 0x35, 0x36, 0xd8, 0x37, 0x39, 0x3a, 0x31, 0x00, 0x3b,
                ...
                0xc5, 0xc6, 0x4e, 0xc7, 0xc8, 0xc9, 0xca, 0x13, 0x01, 0xcc, 0xf5, 0x00, 0xcd, 0xf9, 0x00, 0xce,
                0x59, 0xcf, 0xd0, 0xd1, 0xd2, 0x05, 0x01, 0xd3, 0x34, 0xd4, 0xf9, 0x00, 0xd5, 0xd6, 0x56, 0xd7,
...
def test_macros():
    ...
    l80_path = l80_directory + "/l80"
    print ("   Calling {0} -C100 macros.hex {1}\n".format(l80_path, rel_file))
    out=sp.run([l80_path, "-C100", "macros.hex", rel_file], stdout=sp.PIPE, stderr=sp.STDOUT)
    ...
    # Now we compare the file built by l80 with the expected
    expected = []

    with open('macros.hex', 'rb') as file:
        binary_data = file.read()   
