    ...
    while (1)
    {
        ...
        if (!monta)
        {
            ...
            case EQU:
                ...
                else if (!(aux = expressao())) /* trata expressao */
...
void trata_inst(t_atomo atomo)
{
    ...
    case EXTRN:
        while (1)
        {
            if ((atomo = analex()) == NOME)
                ...
                else if (iec == (sizeof extrn_chain) / (sizeof(ext)))
                {
    ...
    default:
        ...
        case BIT:
            ...
            else if ((!(pilha[0].atr & ABS)) || (pilha[0].valor & ~0x07))
                erro(EXPRESSAO_INVALIDA);
            else if (espera_virgula())
        ...
        case IM:
            if (comp = expressao())
                erro(comp);
            else if (!(pilha[0].atr & ABS) || pilha[0].valor > 2)
